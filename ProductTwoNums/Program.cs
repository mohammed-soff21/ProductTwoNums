namespace ProductTwoNums
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                // welcome message
                WelcomeApp("product of two integers");
                ...
                Print($"The product is: {ProductTwoNums(nFirstNumber, nSecondNumber)}");
        ...
        // 4) this method to calculate product of two integers
        static int ProductTwoNums(int number1, int number2)
        {
